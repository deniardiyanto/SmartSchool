        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendancePoints_Students_StudentId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BarcodeCards_Students_StudentId",
                        column: x => x.StudentId,
                        principalTable: "Students",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "integer", nullable: false),
                    Point = table.Column<int>(type: "integer", nullable: false),
                    ScanBy = table.Column<Guid>(type: "uuid", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Attendances_users_ScannerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendancePoints_StudentId",
                table: "AttendancePoints",
                column: "StudentId");

            migrationBuilder.CreateIndex(
                name: "IX_Attendances_ScannerId",
                table: "Attendances",
                column: "ScannerId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BarcodeCards_StudentId",
                table: "BarcodeCards",
                column: "StudentId");
